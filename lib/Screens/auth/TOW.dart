...
class _VerificationCodePageState extends State<VerificationCodePage> {
  ...
  void _initializeFromArguments() {
    ...
    if (args == null) {
      setState(() {
        _errorMessage = AppLocalizations.of(context)!.translate('missing_auth_data')!;
      });
      return;
    }
    ...
    if (username == null || serverChallenge == null) {
      setState(() {
        _errorMessage = AppLocalizations.of(context)!.translate('missing_required_auth_data')!;
      });
      return;
    }
  ...
  Future<void> _verify2FA() async {
    if (!_isInitialized) {
      setState(() {
        _errorMessage = AppLocalizations.of(context)!.translate('auth_data_not_initialized')!;
      });
      return;
    }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                AppLocalizations.of(context)!.translate('verification_code_from_app')!,
                style: TextStyle(
                  fontSize: 16,
