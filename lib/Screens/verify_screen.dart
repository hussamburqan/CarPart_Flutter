...
class _EmailVerificationPageState extends State<EmailVerificationPage> {
  ...
  final TwoFactorAuthService _2faService = TwoFactorAuthService();
  ...
  Future<void> _verifyEmail() async {
    ...
    try {
      bool isVerified = await _2faService.verifySetup2FA(_code, context);
      if (isVerified) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(AppLocalizations.of(context)!.translate('email_verification')!),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                AppLocalizations.of(context)!.translate('verification_code_sent')!,
                style: TextStyle(
                  fontSize: 16,
